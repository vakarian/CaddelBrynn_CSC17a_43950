...
///Data Structures
struct Settings {
    int **field; ///Holds the game's data
    int rows; ///Rows on minefield
    int columns;///columns on minefield
    int mines; ///number of mines on minefield
...
int main(int argc, const char * argv[]) {
    ...
    ///Take Out Trash(clean up)
     delete player;
            ...
            case 3:
               readFile("result"); //Reads Binary File
                
            default: exitMenu = false; //Exits Menu
        }
